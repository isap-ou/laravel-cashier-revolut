...
/**
 * A subscription model pointed at a table that does not exist.
 *
 ...
 */
class UnwritableSubscription extends RevolutSubscription
{
    protected $table = 'no_such_subscriptions_table';
}
